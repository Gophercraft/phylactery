...
func (engine *engine) Iterate(table_id int32, iteration storage.Iteration) (err error) {
	// Get table
	var table *table
	...
	return iterate_full_record_set(table_id, &table.info.schema, engine.db, iteration)
}
